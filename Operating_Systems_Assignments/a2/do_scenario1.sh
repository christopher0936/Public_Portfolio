...
sleep 1
tmux send-keys -t $NAME:0.1 'curl "localhost:12353/?op=write&val=march2021"' C-m
sleep 0.5
tmux send-keys -t $NAME:0.2 'curl "localhost:12353/?op=read"' C-m
sleep 0.5
tmux send-keys -t $NAME:0.3 'curl "localhost:12353/?op=read"' C-m
sleep 0.5
tmux send-keys -t $NAME:0.4 'curl "localhost:12353/?op=read"' C-m
